...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_all(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                 LT(_FL,KC_SPC),                      KC_RCTRL, KC_LEFT, KC_DOWN,KC_RGHT),
    ...
    [OSX] = LAYOUT_all(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        KC_LCTL, KC_LALT, KC_LGUI,                  _______,                             KC_RALT, _______, _______, _______),
    ...
    [_ADJUST] = LAYOUT_all(
        ...
        EF_DEC,  EF_INC,  H1_DEC,  H1_INC,  H2_DEC,  H2_INC, _______, _______, BR_DEC,  BR_INC, _______, _______, _______, _______, _______,
        _______, _______, S1_DEC,  S1_INC,  S2_DEC,  S2_INC, _______, _______, ES_DEC,  ES_INC, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______,                  _______,                             _______, _______, _______, _______),
