...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_all(
    ...
    KC_LALT, KC_NO, KC_LGUI,                                     LT(2, KC_SPC),                             KC_RGUI, KC_NO, KC_RALT
  ),
  [1] = LAYOUT_all(
	...
	_______, KC_MUTE, KC_VOLU, KC_VOLD, _______, _______, _______, KC_PPLS, KC_PMNS, KC_END, KC_PGDN, KC_DOWN, _______, _______,
